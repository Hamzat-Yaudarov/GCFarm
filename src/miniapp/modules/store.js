...
export function initUpgrades(getTgid, onAfterPurchase){
  ...
  upgradeBtns.forEach(btn=>{
    btn.addEventListener('click', async ()=>{
      ...
      const confirmed = await showConfirm('Подтвердите покупку: ' + (type === 'energy_capacity' ? 'Увеличение вместимости энергии (+25) за 100 SCube' : 'Увеличение дневного лимита (+50) з�� рассчитанную стоимость'));
