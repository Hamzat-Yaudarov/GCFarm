...
export function initWithdrawals(getTgid, onAfterSubmit){
  ...
  const WITHDRAW_METHODS = {
    stars: { key: 'stars', title: 'Вывод как Telegram-звёзды', hint: 'Выберите нужный набор звёзд. Комиссия — 5 SCube на каждые 100 SCube.', options: [ buildWithdrawOption('stars-15','15 Stars',1170,59,'Выплата: 15 Stars'), buildWithdrawOption('stars-25','25 Stars',1950,98,'Выплата: 25 Stars'), buildWithdrawOption('stars-50','50 Stars',3900,195,'Выплата: 50 Stars'), buildWithdrawOption('stars-100','100 Stars',7800,390,'Выплата: 100 Stars') ], fields: [] },
