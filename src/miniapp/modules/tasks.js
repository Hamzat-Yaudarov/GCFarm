...
function attachTaskEventHandlers(taskEl, cardRef, getTgid, onRewarded){
  ...
  const handleTooLong = ()=>{ markState('error'); setTaskFeedback('Сессия рекламы длится слишком долго. Перезапустите мини‑приложение и попробуйте сн��ва.', 'warning'); scheduleTaskReload(1400); };
